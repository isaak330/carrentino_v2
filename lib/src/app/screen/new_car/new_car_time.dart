...
class NewCarTime extends StatefulWidget {
  ...
  const NewCarTime({super.key, required this.bloc});
...
class _NewCarTimeState extends State<NewCarTime> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        SizedBox(height: 90),
        Center(child: Text('Стоимость и время аренды', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 36))),
        SizedBox(height: 100),
        Padding(
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: TextField(
                cursorHeight: 16,
                decoration: const InputDecoration(border: InputBorder.none, hintText: 'Рублей в сутки'),
              ),
            ),
          ),
        ),
        ...
        Center(
          child: Text(
            'Минимальная и максимальнаяграницы аренды:',
              ...
              children: [
                Row(
                  children: [
                    Text('От:'),
                    SizedBox(width: 8),
                    Container(width: 30, child: TextField()),
                    SizedBox(width: 4),
                    Text('д'),
                  ],
                ),
